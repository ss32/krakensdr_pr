    ...
    [
        ...
        dbc.Tooltip(
            [
                ...
                html.P(
                    "Antenna elements placed on a line with having equal distances between each other"
                ),
                html.P("UCA - Uniform Circular Array"),
                html.P(
                    "Antenna elements are placed on circle equaly distributed on 360°"
                ),
            ],
        ...
        dbc.Tooltip(
            [
                html.P(
                    "Forward-backward averegaing improves the performance of DoA estimation in multipath environment"
                ),
...
daq_ini_config_tooltips = html.Div(
    [
        ...
        dbc.Tooltip(
            [
                html.P(
                    "Enables the utilization of the built-in noise source for calibration"
                )
            ],
        ...
        dbc.Tooltip(
            [
                html.P(
                    "Enable DAQ-side squelch to capture burst like signals - NOTE DISABLED IN THIS VERSION, THIS VERSION USES DSP SIDE SQUELCH ONLY"
                )
            ],
        ...
        dbc.Tooltip(
            [
                html.P(
                    "Length of the Coherent Processing Interval (CPI) after decimation"
                )
            ],
        ...
        dbc.Tooltip(
            [
                html.P(
                    "The selected channel is used as a reference for the IQ compensation"
                )
            ],
        ...
        dbc.Tooltip(
            [
                html.P(
                    "Maximum allowed amplitude difference between the receiver channels"
                )
            ],
